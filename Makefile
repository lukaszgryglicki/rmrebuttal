GO_BIN_FILES=cmd/rmrebuttal/rmrebuttal.go
GO_BIN_CMDS=rmrebuttal/cmd/rmrebuttal
...
rmrebuttal: cmd/rmrebuttal/rmrebuttal.go
	 ${GO_ENV} ${GO_BUILD} -o rmrebuttal cmd/rmrebuttal/rmrebuttal.go
