...
RRE='release;;;^\d{4}$' RNAME="yearly" PROJS="allprj envoy grpc opentracing fluentd linkerd coredns rkt cni jaeger notary tuf rook vitess nats opa spiffe spire cncf" ./merge_results.sh
